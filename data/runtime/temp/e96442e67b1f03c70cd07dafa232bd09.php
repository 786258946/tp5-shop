<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:33:"./template/pc/lists_guestbook.htm";i:1545616464;s:24:"./template/pc/header.htm";i:1545615936;s:22:"./template/pc/left.htm";i:1545615936;s:24:"./template/pc/footer.htm";i:1545615936;}*/ ?>
...
<script src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/js/jquery.tips.js"></script>
</head>
<body>
<!--页头开始-->
            ...
            <form class="c-book form_book" method="POST" enctype="multipart/form-data" action="<?php echo $field['action']; ?>">
              <ul class="c-cbli">
                ...
                <li><em>性别</em>
                  ...
                  <?php if(is_array($field['options']) || $field['options'] instanceof \think\Collection || $field['options'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['options'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?>

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"./application/admin/template/seo\seo.htm";i:1573115050;s:61:"D:\wrap\www\demo\application\admin\template\public\layout.htm";i:1573115050;s:55:"D:\wrap\www\demo\application\admin\template\seo\bar.htm";i:1573115050;s:61:"D:\wrap\www\demo\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo url('Seo/handle'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            ...
            <dl class="row <?php if(empty($config['seo_pseudo']) || 1 != $config['seo_pseudo'] || (1 == $config['seo_pseudo'] && 1 == $config['seo_dynamic_format'])): ?>none<?php endif; ?>" id="dl_seo_dynamic_format">
                ...
                <dd class="opt">
                    <label><input type="radio" name="seo_dynamic_format" value="1" <?php if(!isset($config['seo_dynamic_format']) OR $config['seo_dynamic_format'] == 1): ?>checked="checked"<?php endif; ?>>完全兼容（<a href="javascript:void(0);" onclick="view_exp('view_1_1');">查看例子</a><span id="view_1_1" class="none">：http://localhost/demo/index.php?m=home&amp;c=Lists&amp;a=index&amp;tid=1</span>）</label>&nbsp;
                    <?php if(isset($config['seo_dynamic_format']) AND $config['seo_dynamic_format'] == 2): ?>
                    <br/>
                    <label><input type="radio" name="seo_dynamic_format" value="2" checked="checked">部分兼容&nbsp;<font color="red">[部分空间不支持]</font>（<a href="javascript:void(0);" onclick="view_exp('view_1_2');">查看例子</a><span id="view_1_2" class="none">：http://localhost/demo/home/Lists/index.html?tid=1</span>）</label>&nbsp;
                    <?php endif; ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row <?php if(isset($config['seo_pseudo']) && $config['seo_pseudo'] != 3): ?>none<?php endif; ?>" id="dl_seo_rewrite_format">
                ...
                <dd class="opt">
                    <label><input type="radio" name="seo_rewrite_format" value="1" <?php if(!isset($config['seo_rewrite_format']) OR $config['seo_rewrite_format'] == 1): ?>checked="checked"<?php endif; ?>>目录名称（<a href="javascript:void(0);" onclick="view_exp('view_3_1');">查看例子</a><span id="view_3_1" class="none">：http://localhost/demo/about/</span>）</label>&nbsp;
                    <br/>
                    <label><input type="radio" name="seo_rewrite_format" value="2" <?php if(isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 2): ?>checked="checked"<?php endif; ?>>模型标识（<a href="javascript:void(0);" onclick="view_exp('view_3_2');">查看例子</a><span id="view_3_2" class="none">：http://localhost/demo/single/about.html</span>）</label>&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
    ...
    $(function(){
        ...
        $('input[name="seo_force_inlet"]').click(function(){
            if (1 == $(this).val()) {
                layer.open({
                    ...
                    closeBtn: 0,
                    shadeClose: true,
                    content: '//<?php echo \think\Request::instance()->host(); ?>/demo/api/Rewrite/testing.html',
        ...
        function checkInlet() {
            ...
            layer.open({
                ...
                closeBtn: 0,
                shadeClose: true,
                content: '//<?php echo \think\Request::instance()->host(); ?>/demo/api/Rewrite/setInlet.html',
                success: function(layero, index){
                    layer.close(index);
                    var body = layer.getChildFrame('body', index);
                    var content = body.html();
                    if (content.indexOf("Congratulations on passing") == -1)
                    {
                        ...
                        $.ajax({
                            type : "POST",
                            url  : "/demo/index.php?m=api&c=Rewrite&a=setInlet",

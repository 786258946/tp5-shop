<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"D:\wrap\www\demo\core\tpl\dispatch_jump.tpl";i:1573115052;}*/ ?>
...
<head>
    ...
    <style type="text/css">
        *{ padding: 0; margin: 0; }
		...
		.status-ico{margin: 20px auto;width: 73px;height: 76px;display: block;background: url(/demo/public/static/admin/images/ico_right_wrong.png) no-repeat}
		.status-ico-ok{background-position: 0 0}
		.status-ico-error{background-position: -97px 0}
    </style>
    <script type="text/javascript" src="/demo/public/static/common/js/jquery.tools.min.js"></script>
    ...
    <!-- Bootstrap core CSS -->
    <link href="/demo/public/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/template/admin\login.htm";i:1573115048;s:61:"D:\wrap\www\demo\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!DOCTYPE html>
...
<html>
    <head>
        ...
        <link href="/demo/public/static/admin/css/login.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript" src="/demo/public/static/admin/js/jquery.js"></script>
        <script type="text/javascript" src="/demo/public/static/admin/js/jquery.SuperSlide.2.1.2.js"></script>
    ...
    <body>
        ...
        <div class="container">
            <div class="logo">
                ...
                <img src="/demo/public/static/admin/images/logo_ey.png?v=<?php echo time(); ?>">
                <?php else: ?>
                <img src="/demo/public/static/admin/images/logo.png?v=<?php echo time(); ?>">
                <?php endif; ?>
            </div>
            <div class="box">

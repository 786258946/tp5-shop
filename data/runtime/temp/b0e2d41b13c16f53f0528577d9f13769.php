<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"./template/pc/lists_single_contact.htm";i:1545616464;s:24:"./template/pc/header.htm";i:1545615936;s:22:"./template/pc/left.htm";i:1545615936;s:24:"./template/pc/footer.htm";i:1545615936;}*/ ?>
...
#allmap b{color: #CC5522;font-size: 14px; }
 ...
 map.enableDragging();//启用地图拖拽事件，默认启用(可不写)
        ...
        <!--地图结束--></div>
      <div class="page"><a href="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_cmsurl"); echo $__VALUE__; ?>/" title="返回首页" class="back theme_color">返回首页</a> </div>
    </div>
    <!--单页内容结束--> 
  </div>
  <div class="clear"></div>

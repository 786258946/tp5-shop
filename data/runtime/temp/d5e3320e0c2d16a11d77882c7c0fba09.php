<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./application/admin/template/archives\index.htm";i:1573115048;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <!-- <link rel="stylesheet" href="/demo/public/plugins/ztree/css/amazeui.min.css"> -->
    <link rel="stylesheet" href="/demo/public/plugins/ztree/css/iframe.css?v=<?php echo $version; ?>">
    <link rel="stylesheet" href="/demo/public/plugins/ztree/css/zTreeStyle/zTreeStyle.css?v=<?php echo $version; ?>" type="text/css">
    <link href="/demo/public/static/admin/font/css/font-awesome.min.css" rel="stylesheet" />
    <link href="/demo/public/static/admin/css/left_nav_tree.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="/demo/public/static/admin/js/jquery.js"></script>
    <script src="/demo/public/static/admin/js/jquery.layout-latest.min.js"></script>
    <script type="text/javascript" src="/demo/public/plugins/ztree/js/jquery.ztree.core.min.js"></script>
    <script type="text/javascript" src="/demo/public/plugins/layer-v3.1.0/layer.js"></script>
    <!--[if lt IE 9]>
    <script src="/demo/public/static/admin/js/html5shiv.js"></script>
    <script src="/demo/public/static/admin/js/respond.min.js"></script>
    <![endif]-->

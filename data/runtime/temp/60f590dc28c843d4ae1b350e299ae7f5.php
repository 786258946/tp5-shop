<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/template/arctype\index.htm";i:1573115048;s:61:"D:\wrap\www\demo\application\admin\template\public\layout.htm";i:1573115050;s:61:"D:\wrap\www\demo\application\admin\template\public\footer.htm";i:1545615936;}*/ ?>
<!doctype html>
<html>
<head>
              ...
              <tr>
                ...
                <th axis="col3" class="">
                  <div class="sundefined" style="padding-left: 15px">
                    <img src="/demo/public/static/admin/images/tv-expandable.gif" id="all_treeclicked" title="展开所有子栏目" style="float: none;" data-status="close" onClick="treeClicked(this,'all',0);">
                    栏目名称
                  </div>
                </th>
            ...
            <tr nctype="0" <?php if($vo['parent_id'] > 0): ?> style="display:none;"<?php endif; ?> class="parent_id_<?php echo $vo['parent_id']; ?>" data-level="<?php echo $vo['level']; ?>" data-id="<?php echo $vo['id']; ?>">
              ...
              <td class="typename" style="width: 100%">
                <div>
                  ...
                  <img src="/demo/public/static/admin/images/tv-expandable.gif" style="float: none;" fieldid="2" status="open" nc_type="flex" onClick="treeClicked(this,<?php echo $vo['id']; ?>,0);" class="has_children">
                  <?php else: ?>
                  <img src="/demo/public/static/admin/images/tv-collapsable-last.gif" style="float: none;" fieldid="2" status="open" nc_type="flex">
  ...
  <script type="text/javascript">
    ...
    function treeClicked(obj,id,reload){
        if (id == 'all') {
          ...
          if (status == 'close') {
            $('tr[class^=parent_id_]').show().find('img').attr('src', '/demo/public/static/admin/images/tv-collapsable-last.gif');
            $(obj).attr('data-status', 'open').attr('title','关闭所有子栏目').attr('src','/demo/public/static/admin/images/tv-collapsable-last.gif');
          } else {
            ...
            $(obj).attr('data-status', 'close').attr('title','展开所有子栏目').attr('src','/demo/public/static/admin/images/tv-expandable.gif');
          }
         ...
         if(src == '/demo/public/static/admin/images/tv-expandable.gif')
         {
             // $("#treet1 tr").removeClass('tb_child');
             // $(".parent_id_"+id).addClass('tb_child');
             $(".parent_id_"+id).show();
             $(obj).attr('src','/demo/public/static/admin/images/tv-collapsable-last.gif');
             var status = 'close';
         }else{
             $(obj).attr('src','/demo/public/static/admin/images/tv-expandable.gif');     
             var status = 'open';      
              ...
              for (i = 0; i < tbl.rows.length; i++)
              {
                  ...
                  else
                  {
                      if (fnd == true)
                      {
                          ...
                          {
                              $(row).hide();        
                              $(row).find('img.has_children').attr('src','/demo/public/static/admin/images/tv-expandable.gif');
                          }
                          else
                          {
                              fnd = false;

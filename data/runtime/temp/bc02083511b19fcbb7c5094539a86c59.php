<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/index\index.htm";i:1576999735;s:62:"D:\wrap\www\demo\application\admin\template\public\menubox.htm";i:1545615936;s:59:"D:\wrap\www\demo\application\admin\template\public\left.htm";i:1573115050;}*/ ?>
<!doctype html>
<html>
<head>
...
<link rel="shortcut icon" type="image/x-icon" href="/demo/favicon.ico" media="screen"/>
<title>咖啡馆 管理系统</title>
...
<script type="text/javascript" src="/demo/public/static/admin/js/jquery.bgColorSelector.js"></script>
<script type="text/javascript" src="/demo/public/static/admin/js/admincp.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/demo/public/static/admin/js/jquery.validation.min.js"></script>

<!-- <script type="text/javascript" src="/demo/public/plugins/layer/layer.js"></script> -->
<script type="text/javascript" src="/demo/public/plugins/layer-v3.1.0/layer.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="/demo/public/static/admin/js/dialog/dialog.js?v=<?php echo $version; ?>" id="dialog_js"></script>
<script src="/demo/public/static/admin/js/upgrade.js?v=<?php echo $version; ?>"></script>
...
<div class="eycms_cont_left hidden-xs">
    <dl class="eylogo">
        ...
        <a href="<?php echo \think\Request::instance()->url(); ?>"><img id="web_adminlogo" src="/demo/public/static/admin/images/logo_ey.png?v=<?php echo time(); ?>" alt="点击刷新" title="点击刷新"></a>
        <?php else: ?>
        <a href="<?php echo \think\Request::instance()->url(); ?>"><img id="web_adminlogo" src="/demo/public/static/admin/images/logo.png?v=<?php echo time(); ?>" alt="点击刷新" title="点击刷新"></a>
        <?php endif; ?>
    </dl>
